            ...
            <template x-if="isEditingRoom">
                <div class="border-t border-slate-100 pt-4 space-y-2">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-[10px] bg-indigo-50 text-indigo-605 px-2 py-0.5 rounded-full font-bold" x-text="assets.filter(a => a.maPhong === roomForm.maPhong).length + ' tài sản'"></span>
                    </div>
