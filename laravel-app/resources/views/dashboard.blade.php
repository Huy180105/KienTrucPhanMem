...
<div class="flex h-full w-full bg-slate-50 overflow-hidden" 
                ...
                <div class="flex justify-between items-center bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex gap-2">
                            ...
                            <button @click="roomFilter = 'occupied'" :class="roomFilter === 'occupied' ? 'bg-slate-800 text-white' : 'bg-slate-100 hover:bg-slate-200 text-slate-600'" class="px-3 py-1 rounded-lg text-xs font-bold transition">Đã thuê</button>
                        </div>
                    </div>
    ...
    <div x-show="showRoomModal" class="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" x-transition>
        <div @click.away="showRoomModal = false" class="bg-white rounded-2xl w-full max-w-md overflow-hidden shadow-2xl border border-slate-100 flex flex-col">
